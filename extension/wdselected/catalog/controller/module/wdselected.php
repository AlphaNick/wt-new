<?php
namespace Opencart\Catalog\Controller\Extension\Wdselected\Module;
use \Opencart\System\Helper AS Helper;
class Wdselected extends \Opencart\System\Engine\Controller {
	public function index(array $setting): string {
		$this->load->language('extension/wdselected/module/wdselected');
		...
		if ($data['products']) {
			return $this->load->view('extension/wdselected/module/wdselected', $data);
		} else {
			return '';
		}
	}
